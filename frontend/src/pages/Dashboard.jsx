            ...
            <div className="min-h-screen bg-background gradient-calm">
                ...
                <div className="flex items-center justify-center h-screen">
                    <div className="text-center">
                        ...
                        <p className="text-slate-500 text-lg font-medium">Loading your health dashboard...</p>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="min-h-screen bg-background pb-32 lg:pb-12 gradient-calm">
            ...
            <div className="max-w-6xl mx-auto px-6 py-8 pt-28 lg:pt-32">
                ...
                >
                    <h1 className="text-3xl lg:text-4xl font-bold text-slate-800 mb-2">Health Dashboard</h1>
                    <p className="text-slate-500 text-lg">Your daily health monitoring overview</p>
                </motion.header>
                ...
                >
                    <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
                        <div className="p-4 bg-white/70 backdrop-blur-sm rounded-2xl shadow-soft">
                        ...
                        <div className="mt-6 pt-6 border-t border-black/5">
                            ...
                            <ul className="grid gap-2 sm:grid-cols-2">
                                {dashboardData.concerns.map((concern, idx) => (
                                    <li key={idx} className="flex items-center gap-3 bg-white/50 backdrop-blur-sm px-4 py-3 rounded-xl border border-black/5">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-10">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <h3 className="text-xl font-bold text-slate-800">Vitals</h3>
                        </div>

                        {dashboardData?.latest_vitals ? (
                            <div className="space-y-3">
                                {dashboardData.latest_vitals.heart_rate?.value && (
                                    <div className="flex items-center justify-between p-3 bg-slate-50 border border-slate-100 rounded-xl group transition-all duration-300 hover:border-primary-200 hover:shadow-sm">
                                        <div>
                                            <p className="text-xs text-slate-500 font-semibold uppercase tracking-wide">Heart Rate</p>
                                            <p className="text-xl font-bold text-slate-800">{Math.round(dashboardData.latest_vitals.heart_rate.value)} <span className="text-sm font-normal text-slate-500">bpm</span></p>
                                        </div>
                                        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                                            <button
                                                onClick={() => handleEditVital('heart_rate', dashboardData.latest_vitals.heart_rate)}
                                                className="p-2 bg-white border border-slate-200 rounded-lg text-slate-400 hover:text-primary hover:border-primary-200 transition-all duration-300"
                                                title="Edit Vital"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="p-2 bg-white border border-slate-200 rounded-lg text-slate-400 hover:text-red-500 hover:border-red-200 transition-all duration-300 disabled:opacity-50"
                                                title="Delete Vital"
                                            >
                                ...
                                {dashboardData.latest_vitals.blood_pressure?.value && (
                                    <div className="flex items-center justify-between p-3 bg-slate-50 border border-slate-100 rounded-xl group transition-all duration-300 hover:border-primary-200 hover:shadow-sm">
                                        <div>
                                            ...
                                            <p className="text-xl font-bold text-slate-800">{dashboardData.latest_vitals.blood_pressure.value} <span className="text-sm font-normal text-slate-500">mmHg</span></p>
                                        </div>
                                        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                                            <button
                                ...
                                {dashboardData.latest_vitals.blood_sugar?.value && (
                                    <div className="flex items-center justify-between p-3 bg-slate-50 border border-slate-100 rounded-xl group transition-all duration-300 hover:border-primary-200 hover:shadow-sm">
                                        <div>
                                            ...
                                            <p className="text-xl font-bold text-slate-800">{Math.round(dashboardData.latest_vitals.blood_sugar.value)} <span className="text-sm font-normal text-slate-500">mg/dL</span></p>
                                        </div>
                                        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                                            <button
                                ...
                                {dashboardData.latest_vitals.temperature?.value && (
                                    <div className="flex items-center justify-between p-3 bg-slate-50 border border-slate-100 rounded-xl group transition-all duration-300 hover:border-primary-200 hover:shadow-sm">
                                        <div>
                                            ...
                                            <p className="text-xl font-bold text-slate-800">{dashboardData.latest_vitals.temperature.value} <span className="text-sm font-normal text-slate-500">°F</span></p>
                                        </div>
                                        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                                            <button
                                ...
                                {dashboardData.latest_vitals.weight?.value && (
                                    <div className="flex items-center justify-between p-3 bg-slate-50 border border-slate-100 rounded-xl group transition-all duration-300 hover:border-primary-200 hover:shadow-sm">
                                        <div>
                                            ...
                                            <p className="text-xl font-bold text-slate-800">{dashboardData.latest_vitals.weight.value} <span className="text-sm font-normal text-slate-500">kg</span></p>
                                        </div>
                                        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                                            <button
                    ...
                    >
                        <div className="flex items-center gap-4 mb-6">
                            <div className="w-12 h-12 bg-violet-50 rounded-xl flex items-center justify-center text-violet-500 border border-violet-100">
                        ...
                        <div className="space-y-3">
                            <div className="p-4 bg-slate-50 border border-slate-100 rounded-xl text-center">
                                ...
                                <p className="text-4xl font-bold text-slate-800">{dashboardData?.recent_reports_count || 0}</p>
                            </div>
                ...
                <motion.div
                    ...
                    className="mb-12"
                >
                    <h2 className="text-xl font-bold text-slate-800 mb-5">Support & Privacy</h2>
                    <div className="grid md:grid-cols-2 gap-4">
                        <Link to="/guide" className="card-interactive p-5 flex items-center justify-between group">
                            <div className="flex items-center gap-5">
                                <div className="w-11 h-11 bg-blue-50 rounded-xl flex items-center justify-center text-blue-500 border border-blue-100 group-hover:scale-110 transition-transform duration-300">
                                    <BookOpen className="w-5 h-5" />
                                </div>
                                <div>
                                    <h3 className="font-bold text-slate-800">User Guide</h3>
                                    <p className="text-sm text-slate-500">Learn how to use Arodoc</p>
                                </div>
                            </div>
                            <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 group-hover:border-primary group-hover:text-primary transition-all duration-300">
                        ...
                        <Link to="/privacy" className="card-interactive p-5 flex items-center justify-between group">
                            <div className="flex items-center gap-5">
                                <div className="w-11 h-11 bg-emerald-50 rounded-xl flex items-center justify-center text-emerald-500 border border-emerald-100 group-hover:scale-110 transition-transform duration-300">
                                    <Shield className="w-5 h-5" />
                                </div>
                                <div>
                                    <h3 className="font-bold text-slate-800">Privacy & Data</h3>
                                    <p className="text-sm text-slate-500">Control your information</p>
                                </div>
                            </div>
                            <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 group-hover:border-emerald-500 group-hover:text-emerald-500 transition-all duration-300">
                                <Plus className="w-4 h-4 rotate-45" />
                            </div>
                        </Link>
                    </div>
