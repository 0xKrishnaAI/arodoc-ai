                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm" onClick={onCancel}>
                    ...
                    >
                        ...
                        <div className="text-center">
                            <div className="w-14 h-14 bg-red-50 rounded-2xl flex items-center justify-center text-red-500 mx-auto mb-5 border border-red-100">
                                <AlertTriangle className="w-7 h-7" />
                            </div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">Delete {itemName}?</h3>
